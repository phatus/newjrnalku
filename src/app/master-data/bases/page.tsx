...
import { getUserBases } from "../actions";
import BasesClient from "./BasesClient";
import { ChevronLeft } from "lucide-react";
import Link from "next/link";
import { getImplementationBases } from "@/app/activities/actions";

export default async function UserBasesPage() {
    const allBases = await getImplementationBases();
    const userOnlyBases = await getUserBases();
        ...
        <div className="flex flex-col min-h-screen bg-slate-50 pb-10">
            <div className="bg-white border-b border-slate-100 px-6 sm:px-10 py-8">
                ...
                <div>
                    ...
                    <p className="text-slate-500 mt-1 font-medium">Kelola jenis SK atau perintah tugas sebagai dasar kegiatan.</p>
                </div>
            </div>
