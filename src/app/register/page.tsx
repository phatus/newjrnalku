                ...
                <div className="max-w-md w-full py-12">
                    ...
                    <div className="mb-12 flex flex-col items-center gap-6">
                        ...
                        <div className="text-center space-y-2">
                            <h1 className="text-4xl font-black text-slate-900 tracking-tight leading-tight">Daftar Akun</h1>
                            <p className="text-slate-500 font-bold max-w-xs mx-auto text-sm leading-relaxed uppercase tracking-wider">
                                Bergabunglah bersama ratusan guru lainnya.
                            </p>
                        </div>
                    </div>
                    ...
                    <div className="bg-white p-8 sm:p-10 rounded-[2.5rem] shadow-[0_8px_40px_-12px_rgba(0,0,0,0.1)] border border-white relative group">
                        <div className="mb-8">
                            <h2 className="text-2xl font-black text-slate-900 tracking-tight mb-1">Buat Akun Baru</h2>
                            <p className="text-slate-400 text-sm font-medium">Mulai kelola laporan Anda secara otomatis.</p>
                        </div>
                        ...
                        <form action={register} onSubmit={handleSubmit} className="space-y-6">
                            <div className="space-y-2">
                                <label className="text-[10px] font-black text-slate-400 uppercase tracking-[0.2em] ml-1">Nama Lengkap</label>
                                <div className="relative group/input">
                                    <User className="absolute left-4 top-1/2 -translate-y-1/2 h-5 w-5 text-slate-300 group-focus-within/input:text-amber-500 transition-colors" />
                                    <input
                                        type="text"
                                        name="full_name"
                        ...
                        <div className="mt-10 text-center">
                            <p className="text-xs font-bold text-slate-400">
                                Sudah punya akun? <Link href="/login" className="text-amber-600 hover:text-amber-700 font-black uppercase tracking-widest transition-all ml-1">Masuk Sekarang</Link>
                            </p>
                        </div>
                    </div>
                </div>
