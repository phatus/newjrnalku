        ...
        <div className="flex flex-col min-h-[100dvh] px-6 pt-12 pb-8 bg-slate-50">
            <div className="flex-1 flex flex-col justify-center max-w-sm mx-auto w-full">
                <div className="mb-10 text-center">
                    ...
                    <h1 className="text-2xl font-bold text-slate-900 leading-tight">Selamat Datang Kembali</h1>
                    <p className="text-slate-500 mt-2">Masuk untuk mencatat jurnal harian Anda</p>
                </div>
                ...
                <form action={login} onSubmit={handleSubmit} className="space-y-4">
                    ...
                    <div className="space-y-1">
                        <div className="flex justify-between items-center ml-1">
                            ...
                            <Link href="/forgot-password" title="Lupa Kata Sandi" className="text-xs font-medium text-amber-600 hover:text-amber-700">Lupa?</Link>
                        </div>
                        <div className="relative group">
                ...
                <div className="mt-8 text-center text-sm text-slate-500">
                    Belum punya akun? <Link href="/register" title="Daftar Akun" className="font-bold text-amber-600 hover:text-amber-700">Daftar di sini</Link>
                </div>
            </div>
