...
async function run() {
    // The connection pooler URL from .env.local
    const dbUrl = "postgresql://postgres.ouhmkmnczkttbagqcqgr:?b7HPdMrhqavC9Z@aws-1-ap-southeast-1.pooler.supabase.co:6543/postgres";
